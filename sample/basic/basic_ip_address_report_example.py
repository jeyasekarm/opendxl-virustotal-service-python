# This sample invokes and displays the results of a VirusTotal "ip address report" via DXL.
#
...
with DxlClient(config) as client:
    ...
    request_topic = "/opendxl-virustotal/service/vtapi/ip-address/report"
